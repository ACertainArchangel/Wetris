...
\subsubsection{3D Printing Files}
...
\begin{minipage}[t]{0.65\textwidth}
    ...
    Project manager, hardware developer, enclosure design with Solidworks and 3d printing, music module, main.cpp, python utilities, documentation, and final report.
